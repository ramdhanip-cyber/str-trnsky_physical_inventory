          ...
          <Stack spacing={1.5}>
            <Box sx={{ display: 'flex', gap: 1.25, alignItems: 'flex-start' }}>
              ...
              <Box sx={{ minWidth: 0 }}>
                ...
                <Typography variant="body2" fontWeight={600} noWrap title={location.team_name || 'Unassigned'}>
            ...
            <Box sx={{ display: 'flex', gap: 1.25, alignItems: 'flex-start' }}>
              ...
              <Box sx={{ minWidth: 0 }}>
                ...
                <Typography variant="body2" fontWeight={600} noWrap title={location.user_names || 'No one assigned'}>
      ...
      >
        ...
        <Box sx={{ flex: 1, minWidth: 180 }}>
          ...
          <Typography variant="caption" color="text.secondary">
            {location.team_name || 'Unassigned'} · {location.user_names || 'No one assigned'}
          </Typography>
        </Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              <Box>
                ...
                <Typography variant="body2" sx={{ opacity: 0.88, mt: 0.35 }}>
                  Open locations to compare checker and counter counts
                </Typography>
              </Box>
            </Box>
        ...
        {loading ? (
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
              Fetching checker comparison locations…
            </Typography>
          </Paper>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 420, mx: 'auto', mb: 2.5 }}>
              {searchTerm || statusFilter !== 'all'
                ...
                : 'No locations are available for checker vs counter review yet.'}
            </Typography>
            <Button
              variant="contained"
              startIcon={<Refresh />}
